...
cd /Users/puneetlakhanpal/Documents/git/medium-blog-ray-native-app-spcs/ray-native-app-spcs/service/grafana
...
cd ..
REPO_URL=$(snow spcs image-repository url ray_provider_db.ray_provider_schema.ray_provider_image_repo --role ray_provider_role --connection ray_provider_conn)
echo $REPO_URL
...
snow spcs image-registry login --connection ray_provider_conn
...
snow spcs image-repository list-images ray_provider_db.ray_provider_schema.ray_provider_image_repo --role ray_provider_role --connection ray_provider_conn
